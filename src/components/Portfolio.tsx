  ...
  return (
    <div className="min-h-screen bg-white pt-[48px] sm:pt-16 pb-12 " >
      ...
      <Helmet>
        ...
        <meta property="og:image" content="https://formforge.com/twin-spirits-chennai-2023.webp" /> {/* Example image from gallery */}
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "hasPart": IMAGES.map((image) => ({
              "@type": "VisualArtwork",
              "name": image.caption.props.children[0], // Extract the sculpture name
              "image": `https://formforge.com${image.src}`,
              "description": image.alt,
              "contentLocation": {
                "@type": "Place",
                "name": image.caption.props.children[2] // Extract location like "(Chennai) IND, 2023"
              }
            })),
            "contactPoint": {
              "@type": "ContactPoint",
